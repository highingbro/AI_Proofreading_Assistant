...
def test_dynamic_timeout_scales_with_text_length(monkeypatch, llm_env):
    captured_timeouts = []
    ...
    assert config.LLM_TIMEOUT_MIN_SECONDS <= short_timeout <= config.LLM_TIMEOUT_MAX_SECONDS
    assert config.LLM_TIMEOUT_MIN_SECONDS <= long_timeout <= config.LLM_TIMEOUT_MAX_SECONDS
